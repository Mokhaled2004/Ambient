    ...
    <section className="py-24 bg-[#FDFDFD]">
      <div className="max-w-[1400px] mx-auto px-4 md:px-6">
        ...
        <div className="mb-16">
          ...
          <h2 className="text-5xl md:text-7xl lg:text-8xl font-black uppercase tracking-tighter leading-[0.85] mt-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 auto-rows-[180px]">
          {stats.map((stat, index) => (
            <motion.div
              ...
              className={`group relative bg-white border border-black/5 rounded-[2rem] p-8 shadow-sm hover:shadow-xl transition-all overflow-hidden ${stat.gridClass}`}
            >
              {/* Top Row: Icon & ID */}
              ...
              <div className="mt-auto">
                ...
                <p className="text-xs text-black/50 mt-2 font-medium leading-relaxed max-w-[200px]">
                  {stat.desc}
                </p>
              </div>
