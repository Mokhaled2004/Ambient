        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-12">
          ...
          <div className="max-w-3xl">
            <motion.span
              ...
              viewport={{ once: true }}
              className="text-[11px] font-black uppercase tracking-[0.5em] text-[#FF6100] block mb-6"
            >
              {topTag}
            </motion.span>
          ...
          <motion.div
            ...
            className="md:pb-4"
          >
            <p className="text-black/50 font-medium max-w-sm leading-relaxed text-[15px]">
              {description}
            </p>
          </motion.div>
        </div>
